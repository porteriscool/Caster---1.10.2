...
public class ItemAirPickaxe extends ItemPickaxe
{
    public ItemAirPickaxe()
    {
        super(ModItems.elementalMaterial);
        setUnlocalizedName(Reference.MOD_ID.toLowerCase() + ".airpickaxe");
        setRegistryName("airpickaxe");
        setMaxStackSize(1);
